...
<style>
  ...
  .vue-datepicker .data-log{
    background: url("../../assets/image/date-log.png") no-repeat;
  ...
  .vue-datepicker-header-btn:hover {
    color: #008afe;
  }
  ...
  .vue-datepicker-content table {
    width: 100%;
    border-collapse: collapse;
  }

  .vue-datepicker-content table thead {
    line-height: 30px;
    font-size: 12px;
    background: #eee;
  }

  .vue-datepicker-content table tbody tr {
    line-height: 28px;
  }

  .vue-datepicker-content table tbody tr td {
    font-size: 12px;
    text-align: center;
    cursor: pointer;
  }

  .vue-datepicker-content table tbody tr td.active,.active:hover {
    color: #fff;
    background: #008afe;
  }

  .vue-datepicker-content table tbody tr td.flag {
    color: #999;
  }

  .vue-datepicker-content table tbody tr td:hover {
    background: #eee;
  }
  ...
  .vue-date-picker-year-panel ul li {
    font-size: 14px;
    text-align: center;
    line-height: 30px;
    cursor: pointer;
  }
  .vue-date-picker-year-panel ul li.active {
    color: #fff;
    background: #007acc;
  }

  .vue-date-picker-year-panel ul li:first-child {
